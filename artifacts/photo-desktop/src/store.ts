...
export type WindowType = 'photo' | 'gallery' | 'text' | 'link' | 'youtube' | 'drawing' | 'chat' | 'visits' | 'guestbook' | 'sharedphotos' | 'forum' | 'blackjack' | 'flappy' | 'music' | 'polls' | 'chess' | 'cafe' | 'dms' | 'userpage' | 'ranksadmin' | 'userlist' | 'mypage' | 'sitesettings' | 'iplookup' | 'news' | 'diagnostics' | 'sitebackup';
